...
!  integer, parameter :: mi_nr = 26  
  ...
  ! Constant for calculating the amplitudes, this is 1/(2 \rho_gamma^0)^2, if I'm correct.
...
!---------------- 
! adding for the fitting functions
! adding a parameter for correlation type. I'll use this in power_tilt.f90
integer :: CorrType !0 = primary, 1=scalar D-D, 2= scalar P-P, 3 = scalr D-P
                !4 = vector P-P, 5 = tensor P-P
...
!pause
          ...
          CP%InitPower%an(1) = camb_ind
          CP%InitPower%ScalarPowerAmp(1)= amp
